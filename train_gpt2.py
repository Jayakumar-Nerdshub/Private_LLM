...
optimizer = configure_optimizers(model, weight_decay=0.1, learning_rate=6e-4, device_type=device)
...
for iter_num in range(max_steps + 1):
    ...
    if iter_num % 10 == 0:
        ...
        with open(log_file, "a") as f:
            f.write(f"{iter_num}, {loss.item():.4f}\n")

# Save the trained model's state dictionary
model_save_path = r'C:\Users\Admin\Documents\own_model.pth'
